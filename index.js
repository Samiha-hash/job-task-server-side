...
const io = new Server(httpServer, {
  ...
  const uri = `mongodb+srv://${process.env.username}:${process.env.password}@cluster0.b9ubw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get("/", (req, res) => {
    res.send("Hurray My server is running ");
  });
